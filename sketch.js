    ...
    case 1:
      ...
      for (var i = 0; i < asteroids.length; i++) {
        if (astronaut.hits(asteroids[i])) {
          ...
          textFont(font, 30)
          text('Press "F5" to play again', width/2, height/2+100);
          return
...
function astronaut() {
  ...
  function credit(){
    ...
    textAlign(CENTER)
    fill(255)
    text('a girl who brings her dreams to life' , width/2, height/2-90)
    textFont(font2, 45)
    textAlign(CENTER)
    fill(255)
    text('Aya Benziti' , width/2, height/2)
    textFont(font2, 30)
    textAlign(CENTER)
    fill(255)
    text('17th-19th April 2021' , width/2, height/2+120)
    textFont(font2, 50)
    textAlign(CENTER)
    fill(255)
